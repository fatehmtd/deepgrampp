    ...
    namespace listen
    {
        ...
        public:
            ...
            void close()
            {
                ...
                // The keepalive thread's own loop exits once isOpen() goes false
                // (whether that happened here or the socket was already closed,
                // e.g. by the server), so it must always be joined here --
